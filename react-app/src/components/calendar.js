  ...
  constructor(props){
    ...
    render(){
      return(
        ...
        onClickDay={(value) => this.props.pickDay(value)} returnValue="start" value={new Date()} showNeighboringMonth={true} onActiveStartDateChange={(value)=>this.props.monthChange(value)}/> 
      )
    }
